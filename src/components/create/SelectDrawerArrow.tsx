...
import {LineArrowRight, LineCheck} from '@ui/Icons';
import {Drawer} from '@mui/material';
import cx from 'classnames';
import CustomToolTip from '../layout/shared/CustomToolTip';

export interface SelectDrawerArrowItem {
  name: string;
  icon?: string;
  arrowName: string;
  onClick: () => void;
            ...
            >
              ...
              {item.arrowName && (
                <div className={styles.arrowArea}>
                  <div className={styles.arrowName}>{item.arrowName}</div>
