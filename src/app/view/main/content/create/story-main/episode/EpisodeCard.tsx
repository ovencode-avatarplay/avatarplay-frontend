...
const EpisodeCard: React.FC<EpisodeCardProps> = ({
  ...
  const episodeInfo = useSelector((state: RootState) => {
    const flatEpisodes = state.story.curEditingStoryInfo.chapterInfoList.flatMap(chapter => chapter.episodeInfoList);
  ...
  console.log(height);
  const chapters = useSelector((state: RootState) => state.story.curEditingStoryInfo.chapterInfoList);
