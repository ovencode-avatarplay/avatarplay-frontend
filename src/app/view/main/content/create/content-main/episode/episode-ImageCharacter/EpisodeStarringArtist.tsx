...
import styles from './EpisodeStarringArtist.module.css'; // CSS Module import
...
interface EpisodeStarringArtistProps {
  open: boolean; // 모달 열림 상태
  closeModal: () => void; // 모달 닫기 함수
}

const EpisodeStarringArtist: React.FC<EpisodeStarringArtistProps> = ({open, closeModal}) => {
...
export default EpisodeStarringArtist;
