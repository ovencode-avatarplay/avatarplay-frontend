...
const ProfileBase = React.memo(
  ({profileId = 0, onClickBack = () => {}, isPath = false, maxWidth = '1300px'}: ProfileBaseProps) => {
    ...
    return (
      <>
        <section className={styles.header} style={{maxWidth: maxWidth}}>
        ...
        <section className={styles.main}>
          ...
          <section className={styles.tabSection}>
            <div
              ...
              style={{position: isPath ? 'sticky' : 'inherit'}}
